  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div
          role="tooltip"
          className="absolute bottom-full left-1/2 z-50 mb-2 w-64 -translate-x-1/2 rounded-md border border-border bg-popover p-3 text-xs text-popover-foreground shadow-md transition-all animate-in fade-in-0 zoom-in-95 duration-150"
        >
          {title !== undefined && (
