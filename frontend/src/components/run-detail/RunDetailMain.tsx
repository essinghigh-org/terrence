...
import type { AssessmentCheck, PhaseResource, PolicyCheck, RunAttributes } from "@/lib/run-view-state";
  ...
  return (
    <>
      ...
      <div className="order-2 min-w-0 space-y-5 xl:order-1">
        ...
        {props.cost.showCostEstimate && <CostSection cost={props.cost} />}
        ...
        {props.assessmentChecks.length > 0 && <AssessmentSection assessmentChecks={props.assessmentChecks} />}
