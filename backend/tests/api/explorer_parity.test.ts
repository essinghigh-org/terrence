...
describe("Explorer API (the reference format Parity)", () => {
  let token: string;
  let orgName: string;
  ...
  test("GET /organizations/:org_name/explorer returns type 'workspaces' and the reference format attributes", async () => {
