...
export const runs = pgTable(
  "runs",
  {
    ...
    executionFencingToken: bigint("execution_fencing_token", { mode: "number" }).notNull().default(0),
    executionLeaseExpiresAt: bigint("execution_lease_expires_at", { mode: "number" }),
    executionLeaseHeartbeatAt: bigint("execution_lease_heartbeat_at", { mode: "number" }),
...
export const workspaces = pgTable(
  "workspaces",
  {
    ...
    executionOwnerNodeId: text("execution_owner_node_id"),
    executionOwnerInstanceId: text("execution_owner_instance_id"),
    executionFencingToken: bigint("execution_fencing_token", { mode: "number" }),
    executionLeaseExpiresAt: bigint("execution_lease_expires_at", { mode: "number" }),
    executionLeaseHeartbeatAt: bigint("execution_lease_heartbeat_at", { mode: "number" }),
