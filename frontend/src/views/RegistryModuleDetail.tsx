            ...
            {module.permissions.canDelete && selectedVersion !== null && (
              <Card>
                ...
                <CardContent className="grid gap-2">
                  ...
                  <Link className="text-center text-sm text-primary hover:underline" to={registryPath.replace(/\/registry$/, "/settings/module-sharing")}>Module sharing</Link>
                  <Link className="text-center text-sm text-primary hover:underline" to={`/app/${encodeURIComponent(orgName)}/no-code`}>No-code provisioning</Link>
