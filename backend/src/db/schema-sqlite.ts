...
export const organizations = sqliteTable("organizations", {
  ...
  aggregatedCommitStatusEnabled: integer("aggregated_commit_status_enabled", { mode: "boolean" })
    .notNull()
    .default(true),
  sendPassingStatusesForUntriggeredSpeculativePlans: integer("send_passing_statuses", { mode: "boolean" })
    .notNull()
    .default(false),
...
export const scimUserIdentities = sqliteTable(
...
export const scimGroupMemberships = sqliteTable(
...
export const registryPartnerships = sqliteTable(
...
export const reservedTagKeys = sqliteTable(
  "reserved_tag_keys",
  {
    id: text("id").primaryKey(),
    orgId: text("org_id")
...
export const organizationMembershipRoles = sqliteTable(
...
export const teams = sqliteTable(
  "teams",
  {
    ...
    organizationAccess: text("organization_access", { mode: "json" })
...
export const teamScimGroupMappings = sqliteTable(
...
export const workspaces = sqliteTable(
  "workspaces",
  {
    ...
    vcsRepo: text("vcs_repo", { mode: "json" }).$type<{
      branch?: string;
      identifier?: string;
      oauthTokenId?: string;
...
export const remoteStateConsumers = sqliteTable(
...
export const teamWorkspaces = sqliteTable(
  "team_workspaces",
  {
    id: text("id").primaryKey(),
    teamId: text("team_id")
 ...
 */
export const notificationDeliveryState = sqliteTable(
...
export const workspaceVariables = sqliteTable(
  "workspace_variables",
  {
    id: text("id").primaryKey(),
    workspaceId: text("workspace_id")
...
export const configurationVersions = sqliteTable(
  "configuration_versions",
  {
    ...
    source: text("source").default("tfe-api"),
    ingressAttributes: text("ingress_attributes", { mode: "json" }).$type<{
      commitSha?: string;
      commitUrl?: string;
...
export const runProvenanceCapsules = sqliteTable(
...
// workspace.
export const runTokens = sqliteTable(
  "run_tokens",
  {
    id: text("id").primaryKey(),
    tokenHash: text("token_hash").notNull().unique(),
...
export const assessmentCheckResults = sqliteTable(
  "check_results",
  {
    id: text("id").primaryKey(),
    workspaceId: text("workspace_id")
...
export const runExplanations = sqliteTable(
  "run_explanations",
  {
    id: text("id").primaryKey(),
    runId: text("run_id")
...
export const controlPlaneNodes = sqliteTable(
  "control_plane_nodes",
  {
    id: text("id").primaryKey(),
...
export const stateOutputIndex = sqliteTable(
  "state_output_index",
  {
...
export const variableSetWorkspaces = sqliteTable(
...
export const stackVariableSets = sqliteTable(
  "stack_variable_sets",
  {
...
export const stackRecords = sqliteTable(
  "stack_records",
  {
    id: text("id").primaryKey(),
    stackId: text("stack_id")
...
export const stackAgentJobs = sqliteTable(
  "stack_agent_jobs",
  {
    id: text("id").primaryKey(),
    stackId: text("stack_id")
...
export const stackStateLocks = sqliteTable(
  "stack_state_locks",
  {
    id: text("id").primaryKey(),
    stackId: text("stack_id")
...
export const workloadIdentityTokens = sqliteTable(
...
export const explorerWorkspaceInventory = sqliteTable(
...
export const explorerCatalogItems = sqliteTable(
...
export const explorerCatalogMemberships = sqliteTable(
...
export const variableSetProjects = sqliteTable(
...
export const variableSetVariables = sqliteTable(
...
export const oauthHandshakeStates = sqliteTable(
...
export const registrySyncLeases = sqliteTable(
...
export const policySetVersions = sqliteTable(
  "policy_set_versions",
  {
    id: text("id").primaryKey(),
    ...
    status: text("status").notNull().default("pending"),
    statusTimestamps: text("status_timestamps", { mode: "json" })
      .$type<{ uploadedAt?: string; readyAt?: string; erroredAt?: string }>()
      .notNull()
      .default({}),
    statusMetadataSchemaVersion: integer("status_metadata_schema_version").notNull().default(0),
    ingressAttributes: text("ingress_attributes", { mode: "json" }).$type<{
...
export const policySetWorkspaces = sqliteTable(
...
export const policyChecks = sqliteTable(
  "policy_checks",
  {
    id: text("id").primaryKey(),
    runId: text("run_id")
...
export const registryModules = sqliteTable(
  "registry_modules",
  {
    id: text("id").primaryKey(),
    orgId: text("org_id")
...
export const registryModuleVersions = sqliteTable(
...
export const noCodeModules = sqliteTable(
  "no_code_modules",
  {
    id: text("id").primaryKey(),
    moduleId: text("module_id")
...
export const noCodeVariableOptions = sqliteTable(
...
export const testVariables = sqliteTable(
  "test_variables",
  {
    id: text("id").primaryKey(),
    moduleId: text("module_id")
...
export const noCodeWorkspaceConfigurations = sqliteTable(
...
export const registryProviders = sqliteTable(
  "registry_providers",
  {
    id: text("id").primaryKey(),
    orgId: text("org_id")
...
export const registryGpgKeys = sqliteTable(
  "registry_gpg_keys",
  {
    id: text("id").primaryKey(),
    orgId: text("org_id")
...
export const providerSets = sqliteTable(
  "provider_sets",
  {
    id: text("id").primaryKey(),
    orgId: text("org_id")
...
export const registryProviderVersions = sqliteTable(
...
export const registryProviderPlatforms = sqliteTable(
...
export const explorerBulkActionRecords = sqliteTable(
  "change_requests",
  {
    id: text("id").primaryKey(),
    workspaceId: text("workspace_id")
...
export const policySetProjects = sqliteTable(
  "policy_set_projects",
  {
    id: text("id").primaryKey(),
    policySetId: text("policy_set_id")
...
export const policySetTagSelectors = sqliteTable(
...
export const policySetExclusions = sqliteTable(
...
export const policySetProjectExclusions = sqliteTable(
...
export const oauthClientProjects = sqliteTable(
...
export const agentPoolAllowedWorkspaces = sqliteTable(
...
export const orgTokenTTLPolicies = sqliteTable(
...
export const agentPoolAllowedProjects = sqliteTable(
...
export const agentPoolExcludedWorkspaces = sqliteTable(
...
export const agents = sqliteTable(
  "agents",
  {
    ...
    artifactFormats: text("artifact_formats", { mode: "json" })
      .$type<string[]>()
      .notNull()
      .default(["tar.gz", "json", "text"]),
...
export const agentForwardedRequests = sqliteTable(
...
export const runTasks = sqliteTable("run_tasks", {
  ...
  globalConfiguration: text("global_configuration", { mode: "json" }).$type<{
    enabled: boolean;
    stages: string[];
...
export const workspaceRunTasks = sqliteTable(
  "workspace_run_tasks",
  {
    id: text("id").primaryKey(),
    workspaceId: text("workspace_id")
...
export const runTaskResults = sqliteTable(
  "run_task_results",
  {
    id: text("id").primaryKey(),
    runId: text("run_id")
...
export const policyEvaluations = sqliteTable(
  "policy_evaluations",
  {
    id: text("id").primaryKey(),
    taskStageId: text("task_stage_id").references(() => taskStages.id, { onDelete: "cascade" }),
...
export const runTriggers = sqliteTable(
  "run_triggers",
  {
    id: text("id").primaryKey(),
    workspaceId: text("workspace_id")
...
export const cidrRangeListAgentPools = sqliteTable(
...
export const notificationConfigurationWorkspaceExclusions = sqliteTable(
...
export const adminGeneralSettings = sqliteTable("admin_general_settings", {
  id: text("id").primaryKey(),
  limitUserOrganizationCreation: integer("limit_user_organization_creation", { mode: "boolean" })
    .notNull()
    .default(true),
  ...
  sendPassingStatusesForUntriggeredSpeculativePlans: integer("send_passing_statuses", { mode: "boolean" })
    .notNull()
    .default(false),
  allowSpeculativePlansOnPullRequestsFromForks: integer("allow_speculative_plans_forks", { mode: "boolean" })
    .notNull()
    .default(false),
...
export const ssoChallenges = sqliteTable(
  "sso_challenges",
  {
    id: text("id").primaryKey(),
    kind: text("kind").notNull(),
...
export const moduleTestConfigurationVersions = sqliteTable(
...
export const moduleTestRuns = sqliteTable(
  "module_test_runs",
  {
    id: text("id").primaryKey(),
    moduleId: text("module_id")
