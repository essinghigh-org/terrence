 ...
 * lines for illustrations rendered at or below 128px.
 */
export function Terrence({ pose = "welcome", className, animated = false, detail = "full" }: Readonly<{
  pose?: TerrencePose;
  className?: string;
  animated?: boolean;
  ...
  return (
    <svg viewBox="0 0 320 280" fill="none" aria-hidden="true" focusable="false" className={cn("terrence-mascot", animated && "terrence-mascot--animated", className)} data-pose={pose} data-detail={detail}>
