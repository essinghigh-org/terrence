...
export const apiIdempotencyKeys = pg[dbNameOf(sqliteSchema.apiIdempotencyKeys)];
...
export const controlEvents = pg[dbNameOf(sqliteSchema.controlEvents)];
export const controlPlaneLeases = pg[dbNameOf(sqliteSchema.controlPlaneLeases)];
...
export const emailVerificationTokens = pg[dbNameOf(sqliteSchema.emailVerificationTokens)];
export const explorerBulkActionRecords = pg[dbNameOf(sqliteSchema.explorerBulkActionRecords)];
...
export const identityLinks = pg[dbNameOf(sqliteSchema.identityLinks)];
...
export const organizationInvitations = pg[dbNameOf(sqliteSchema.organizationInvitations)];
...
export const rateLimitBuckets = pg[dbNameOf(sqliteSchema.rateLimitBuckets)];
export const refreshSessions = pg[dbNameOf(sqliteSchema.refreshSessions)];
export const registryComponents = pg[dbNameOf(sqliteSchema.registryComponents)];
...
export const runProvenanceCapsules = pg[dbNameOf(sqliteSchema.runProvenanceCapsules)];
...
export const stateOutputIndex = pg[dbNameOf(sqliteSchema.stateOutputIndex)];
