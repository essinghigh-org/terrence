...
export const subsystemEnvironmentNames = [
  ...
  "SIGNED_URL_SECRET",
  "SIMULATED_ASSESSMENT_JSON",
  "SIMULATED_ASSESSMENT_SCHEMA",
  "SIMULATED_PLAN_JSON",
  "TERRAFORM_CONFIG_INSPECT_PATH",
  "TERRAFORM_TEST_BINARY_PATH",
  "TERRENCE_AGENT_UPDATE_SHA256",
  "TERRENCE_AGENT_UPDATE_URL",
  "TERRENCE_AGENT_UPDATE_VERSION",
  "TERRENCE_BINARY_CACHE_DIR",
  "TERRENCE_COMPATIBILITY_VERSION",
