...
function SamlAuthSection({ section, userOpen, onToggle }: Readonly<{
...
function OidcAuthSection({ section, userOpen, onToggle }: Readonly<{
...
function LdapAuthSection({ section, userOpen, onToggle }: Readonly<{
