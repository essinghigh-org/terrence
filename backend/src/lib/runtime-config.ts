...
export const integerConfiguration = {
  ...
  TERRENCE_DB_EXPORT_QUERY_CONCURRENCY: { default: 1, min: 1, max: 64 },
  TERRENCE_DB_EXPORT_QUERY_QUEUE: { default: 8, min: 0, max: 1024 },
  TERRENCE_DB_INDEX_QUERY_CONCURRENCY: { default: 2, min: 1, max: 64 },
  TERRENCE_DB_INDEX_QUERY_QUEUE: { default: 32, min: 0, max: 4096 },
  TERRENCE_DB_QUERY_BUDGET_WAIT_MS: { default: 30000, min: 1, max: 2147483647 },
