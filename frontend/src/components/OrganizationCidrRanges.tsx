...
export function OrganizationCidrRanges({ orgName }: Readonly<{ orgName: string }>): React.JSX.Element {
  ...
  return <Card>
    <CardHeader><CardTitle>CIDR ranges</CardTitle><CardDescription>Manage organization network ranges used by policy and ingress controls.</CardDescription></CardHeader>
