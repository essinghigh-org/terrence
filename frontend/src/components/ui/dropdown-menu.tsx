...
type MenuLabelProps = DeepReadonly<
  MenuPrimitive.GroupLabel.Props & {
    readonly inset?: boolean;
  }
>;

function DropdownMenuLabel({ className, inset, ...props }: MenuLabelProps): JSX.Element {
  return (
...
type MenuItemProps = DeepReadonly<
...
function DropdownMenuItem({ className, inset, variant = "default", ...props }: MenuItemProps): JSX.Element {
  return (
    <MenuPrimitive.Item
...
type MenuSubTriggerProps = DeepReadonly<
  MenuPrimitive.SubmenuTrigger.Props & {
    readonly inset?: boolean;
  }
>;

function DropdownMenuSubTrigger({ className, inset, children, ...props }: MenuSubTriggerProps): JSX.Element {
...
type MenuCheckboxProps = DeepReadonly<
  MenuPrimitive.CheckboxItem.Props & {
    readonly inset?: boolean;
  }
>;

function DropdownMenuCheckboxItem({ className, children, checked, inset, ...props }: MenuCheckboxProps): JSX.Element {
  // SAFETY: the primitive's Props type widens children; the cast restores ReactNode for the JSX child slot.
  const childNode = children as React.ReactNode;
  return (
...
type MenuRadioProps = DeepReadonly<
  MenuPrimitive.RadioItem.Props & {
    readonly inset?: boolean;
  }
>;

function DropdownMenuRadioItem({ className, children, inset, ...props }: MenuRadioProps): JSX.Element {
  // SAFETY: the primitive's Props type widens children; the cast restores ReactNode for the JSX child slot.
  const childNode = children as React.ReactNode;
  return (
...
function DropdownMenuSeparator({ className, ...props }: DeepReadonly<MenuPrimitive.Separator.Props>): JSX.Element {
  return (
...
function DropdownMenuShortcut({ className, ...props }: DeepReadonly<ComponentProps<"span">>): JSX.Element {
  return (
    <span
